...
class Menu:
    ...
    def __init__(self, opciones):
        self.opciones = []
        fuente = pygame.font.Font('COMICATE.ttf', 40)
        x = 300
        y = 230
        paridad = 1
...
if __name__ == '__main__':
    ...
    fondo = pygame.image.load("redb.png").convert()
    pygame.display.set_caption("Juego Red Ball")
    title = pygame.image.load("redball.png")
    ...
    while not salir:
        ...
        #sonido=pygame.mixer.music.load("intro.mp3")
