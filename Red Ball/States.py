...
class AnimatedState(EntityState):
    ...
    def update(self, dt):
        ...
        if self.current_delta > self.speed:
            self.current_delta = 0
        #indice del sprite que esta actualmente
