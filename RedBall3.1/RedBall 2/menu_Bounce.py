...
class Menu:
    ...
    def __init__(self, opciones):
        ...
        self.opciones = []
        fuente = pygame.font.Font('tipografia/COMICATE.ttf', 40)
        x = 300
        y = 230
        paridad = 1

        self.cursor = Cursor(x - 35, y, 35)
...
if __name__ == '__main__':
    ...
    pygame.display.set_caption("Juego Red Ball")
    title = pygame.image.load("Imagenes/redball.png")
    fondo = pygame.transform.scale(fondo,(800,600))
    title = pygame.transform.scale(title,(100,50))
    ...
    while not salir:
        ...
        #sonido=pygame.mixer.music.load("Sonido/intro.mp3")
        #pygame.mixer.music.play(1) 
        menu.actualizar()
        menu.imprimir(screen)
   
        pygame.display.flip()
        #sonido.pygame.mixer.music.stop()
